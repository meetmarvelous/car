...
<head>
  <title>Titiabiks Ventures | Car Listing</title>
  <!--Bootstrap -->
          ...
          <div class="result-sorting-wrapper">
            <div class="sorting-count">
              ...
              $sql = "SELECT tblvehicles.id FROM tblvehicles 
                      ...
                      WHERE tblvehicles.VehiclesTitle = '$searchdata' 
                      OR tblvehicles.FuelType = '$searchdata' 
                      OR tblbrands.BrandName = '$searchdata' 
                      OR tblvehicles.ModelYear = '$searchdata'";
            ...
            <div class="recent_addedcars">
              <ul>
                ...
                if (mysqli_num_rows($result) > 0) {
                  while ($row = mysqli_fetch_assoc($result)) { ?>
                    <li class="gray-bg">
                      <div class="recent_post_img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($row['id']); ?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($row['Vimage1']); ?>" alt="image"></a> </div>
                      <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($row['id']); ?>"><?php echo htmlentities($row['BrandName']); ?>, <?php echo htmlentities($row['VehiclesTitle']); ?></a>
                        <p class="widget_price">₦<?php echo htmlentities($row['PricePerDay']); ?> Per Day</p>
                      </div>
                    </li>
                <?php }
                } ?>
