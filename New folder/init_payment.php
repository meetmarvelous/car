...
if (mysqli_query($con, $sql)) {
  ...
  try {
    ...
    $transaction = $paystack->transaction->initialize([
      ...
      'reference' => $reference,
      'callback_url' => 'https://blog.marvelbyte.xyz/payment_confirmation.php', // Replace with your domain
      'metadata' => [
        'booking_id' => $bookingId,
        'booking_no' => $bookingNo,
        'cancel_url' => 'https://blog.marvelbyte.xyz/my-booking.php' // Add cancel URL
      ]
    ]);
