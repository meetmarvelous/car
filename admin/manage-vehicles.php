...
{	
    ...
    if(isset($_REQUEST['del']))
    {
        ...
        if($result){
            ...
            $error = "Error deleting vehicle record: " . mysqli_error($con);
        }
    }
?>
...
<head>
    ...
    <title>Titiabiks Ventures | Admin Manage Vehicles</title>
...
?>	
    <tr>
        ...
        <td>
            <a href="edit-vehicle.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
            <a href="manage-vehicles.php?del=<?php echo $row['id'];?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a>
        </td>
    </tr>
    <?php $cnt = $cnt + 1; }} ?>
