...
<head>
    ...
    <title>Titiabiks Ventures | Admin Edit Vehicle Info</title>
...
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($row['VehiclesTitle'])?>" required>
</div>
...
if(mysqli_num_rows($result2) > 0)
{
    ...
    {
        if($row2['BrandName']==$bdname)
        {
            continue;
        } else{
?>
<option value="<?php echo htmlentities($row2['id']);?>"><?php echo htmlentities($row2['BrandName']);?></option>
<?php }}} ?>
...
<div class="col-sm-10">
<textarea class="form-control" name="vehicalorcview" rows="3" required><?php echo htmlentities($row['VehiclesOverview']);?></textarea>
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($row['PricePerDay']);?>" required>
</div>
...
<div class="col-sm-4">
<input type="text" name="modelyear" class="form-control" value="<?php echo htmlentities($row['ModelYear']);?>" required>
</div>
<label class="col-sm-2 control-label">Seating Capacity<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="seatingcapacity" class="form-control" value="<?php echo htmlentities($row['SeatingCapacity']);?>" required>
</div>
</div>
<div class="hr-dashed"></div>								
<div class="form-group">
...
<a href="changeimage4.php?imgid=<?php echo htmlentities($row['id'])?>">Change Image 4</a>
</div>
<div class="col-sm-4">
Image 5
<?php if($row['Vimage5']=="")
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($row['id'])?>">Change Image 5</a>
<?php } ?>
</div>
