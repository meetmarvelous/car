...
{	
    ...
    if($_POST['submit']=="Update")
    {
        ...
        if($result){
            ...
            $error = "Error updating page data: " . mysqli_error($con);
        }
    }
?>
...
<head>
    ...
    <title>Titiabiks Ventures | Admin Manage Pages</title>
                                    ...
                                    <div class="panel-body">
                                        <form method="post" name="chngpwd" class="form-horizontal" onSubmit="return valid();">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" rows="5" cols="50" name="pgedetails" id="pgedetails" placeholder="Page Details" required>
                                                        <?php 
                                                        $pagetype = $_GET['type'];
