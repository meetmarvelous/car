...
?>
  ...
  <head>
    ...
    <title>Titiabiks Ventures | Admin Update Image 2</title>
                    ...
                    <div class="panel-body">
                      <form method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <?php
                          $id = intval($_GET['imgid']);
                          $sql = "SELECT Vimage2 FROM tblvehicles WHERE id = '$id'";
                          $result = mysqli_query($con, $sql);
                          if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                          ?>
                              <div class="col-sm-8">
                                <img src="img/vehicleimages/<?php echo htmlentities($row['Vimage2']); ?>" width="300" height="200" style="border:solid 1px #000">
                              </div>
                          <?php }
                          } ?>
                        </div>
