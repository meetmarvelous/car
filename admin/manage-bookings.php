...
{	
    ...
    if(isset($_REQUEST['eid']))
    {
        ...
        if($result){
            ...
            $error = "Error cancelling booking: " . mysqli_error($con);
        }
    }
    ...
    if(isset($_REQUEST['aeid']))
    {
        ...
        if($result){
            ...
            $error = "Error confirming booking: " . mysqli_error($con);
        }
    }
?>
...
<head>
    ...
    <title>Titiabiks Ventures | Admin Manage Bookings</title>
                                ...
                                <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    ?>	
                                        <tr>
                                            ...
                                            <td>
                                                <a href="manage-bookings.php?aeid=<?php echo htmlentities($row['id']);?>" onclick="return confirm('Do you really want to Confirm this booking')"> Confirm</a> /
                                                <a href="manage-bookings.php?eid=<?php echo htmlentities($row['id']);?>" onclick="return confirm('Do you really want to Cancel this Booking')"> Cancel</a>
                                            </td>
                                        </tr>
                                        <?php $cnt = $cnt + 1; }} ?>
