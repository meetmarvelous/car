...
?>
  ...
  <head>
    <title>Titiabiks Ventures | My Testimonials </title>
    <!--Bootstrap -->
            ...
            <div class="user_profile_info gray-bg padding_4x4_40">
              ...
              <div class="dealer_info">
                ...
                <p><?php echo htmlentities($row['Address']); ?><br>
                  <?php echo htmlentities($row['City']); ?>&nbsp;<?php echo htmlentities($row['Country']);
                                                                }
                                                              } ?></p>
              </div>
            </div>
                          ...
                          while ($row = mysqli_fetch_assoc($result)) { ?>
                            <li>
                              <div>
                                ...
                                <p><b>Posting Date:</b><?php echo htmlentities($row['PostingDate']); ?> </p>
                              </div>
                              <?php if ($row['status'] == 1) { ?>
